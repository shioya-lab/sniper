...
class MemoryManagerBase
{
   ...
   public:
      ...
      virtual HitWhere::where_t coreInitiateMemoryAccess(
            ...
            Core::MemModeled modeled, IntPtr eip = 0, uint64_t uop_idx = 0, bool use_prefetch = true) = 0;
      ...
      virtual HitWhere::where_t corePrefetchMemoryAccess (
         SubsecondTime core_time,
         MemComponent::component_t mem_component,
         Core::lock_signal_t lock_signal,
         Core::mem_op_t mem_op_type) = 0;
