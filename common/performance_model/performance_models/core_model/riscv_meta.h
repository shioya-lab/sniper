...
enum rv_op
{
	...
	rv_op_vfrsub_vx = 871,
	rv_op_vfmadd_vx = 872,
	rv_op_vfnmadd_vx = 873,
	rv_op_vfmsub_vx = 874,
	rv_op_vfnmsub_vx = 875,
	rv_op_vfmacc_vx = 876,
	rv_op_vfnmacc_vx = 877,
	rv_op_vfmsac_vx = 878,
	rv_op_vfnmsac_vx = 879,
	rv_op_vfwadd_vx = 880,
	rv_op_vfwredsum_vx = 881,
	rv_op_vfwsub_vx = 882,
	rv_op_vfwredosum_vx = 883,
	rv_op_vfwadd_wv = 884,
	rv_op_vfwsub_wv = 885,
	rv_op_vfwmul_vx = 886,
	rv_op_vfdot_vx = 887,
	rv_op_vfwmacc_vx = 888,
	rv_op_vfwnmacc_vx = 889,
	rv_op_vfwmsac_vx = 890,
	rv_op_vfwnmsac_vx = 891,
	rv_op_vfadd_vf = 892,
...
const riscvinstr instrlist[] = {
	...
	{ rv_op_vleff8_v       ,0, 0, 0, 0, 0, 0, 1, 1 },  // 328,
	{ rv_op_vleff16_v      ,0, 0, 0, 0, 0, 0, 1, 1 },  // 329,
	{ rv_op_vleff32_v      ,0, 0, 0, 0, 0, 0, 1, 1 },  // 330,
	{ rv_op_vleff64_v      ,0, 0, 0, 0, 0, 0, 1, 1 },  // 331,
	...
	{ rv_op_vdivu_vv       ,1, 0, 0, 0, 0, 0, 0, 1 },  // 512,
	{ rv_op_vdiv_vv        ,1, 0, 0, 0, 0, 0, 0, 1 },  // 513,
	{ rv_op_vremu_vv       ,1, 0, 0, 0, 0, 0, 0, 1 },  // 514,
	{ rv_op_vrem_vv        ,1, 0, 0, 0, 0, 0, 0, 1 },  // 515,
	...
	{ rv_op_vdivu_vx       ,1, 0, 0, 0, 0, 0, 0, 1 },  // 545,
	{ rv_op_vdiv_vx        ,1, 0, 0, 0, 0, 0, 0, 1 },  // 546,
	{ rv_op_vremu_vx       ,1, 0, 0, 0, 0, 0, 0, 1 },  // 547,
	{ rv_op_vrem_vx        ,1, 0, 0, 0, 0, 0, 0, 1 },  // 548,
	...
	{ rv_op_vfmul_vx       ,0, 0, 0, 1, 0, 0, 0, 1 },  // 590,
	{ rv_op_vfrsub_vx      ,0, 0, 0, 1, 0, 0, 0, 1 },  // 591,
	{ rv_op_vfmadd_vx      ,0, 0, 0, 1, 0, 0, 0, 1 },  // 592,
	{ rv_op_vfnmadd_vx     ,0, 0, 0, 1, 0, 0, 0, 1 },  // 593,
	{ rv_op_vfmsub_vx      ,0, 0, 0, 1, 0, 0, 0, 1 },  // 594,
	{ rv_op_vfnmsub_vx     ,0, 0, 0, 1, 0, 0, 0, 1 },  // 595,
	{ rv_op_vfmacc_vx      ,0, 0, 0, 1, 0, 0, 0, 1 },  // 596,
	{ rv_op_vfnmacc_vx     ,0, 0, 0, 1, 0, 0, 0, 1 },  // 597,
	{ rv_op_vfmsac_vx      ,0, 0, 0, 1, 0, 0, 0, 1 },  // 598,
	{ rv_op_vfnmsac_vx     ,0, 0, 0, 1, 0, 0, 0, 1 },  // 599,
	{ rv_op_vfwadd_vx      ,0, 0, 0, 1, 0, 0, 0, 1 },  // 600,
	{ rv_op_vfwredsum_vx   ,0, 0, 0, 1, 0, 0, 0, 1 },  // 601,
	{ rv_op_vfwsub_vx      ,0, 0, 0, 1, 0, 0, 0, 1 },  // 602,
	{ rv_op_vfwredosum_vx  ,0, 0, 0, 1, 0, 0, 0, 1 },  // 603,
	{ rv_op_vfwadd_wv      ,0, 0, 0, 1, 0, 0, 0, 1 },  // 604,
	{ rv_op_vfwsub_wv      ,0, 0, 0, 1, 0, 0, 0, 1 },  // 605,
	{ rv_op_vfwmul_vx      ,0, 0, 0, 1, 0, 0, 0, 1 },  // 606,
	{ rv_op_vfdot_vx       ,0, 0, 0, 1, 0, 0, 0, 1 },  // 607,
	{ rv_op_vfwmacc_vx     ,0, 0, 0, 1, 0, 0, 0, 1 },  // 608,
	{ rv_op_vfwnmacc_vx    ,0, 0, 0, 1, 0, 0, 0, 1 },  // 609,
	{ rv_op_vfwmsac_vx     ,0, 0, 0, 1, 0, 0, 0, 1 },  // 610,
	{ rv_op_vfwnmsac_vx    ,0, 0, 0, 1, 0, 0, 0, 1 },  // 611,
	...
	{ rv_op_vfmv_vf        ,0, 0, 0, 1, 0, 0, 0, 1 },  // 623,
